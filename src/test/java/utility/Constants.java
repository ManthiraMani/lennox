...
public class Constants {
	...
	public static	String SUITE_XL_PATH = System.getProperty("user.dir") + "\\data\\Suite.xlsx";
	public static   String SUITE1_XL_PATH=System.getProperty("user.dir") + "\\data\\BankManagerSuite.xlsx";
